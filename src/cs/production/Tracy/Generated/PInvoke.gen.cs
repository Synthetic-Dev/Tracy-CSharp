...
// <auto-generated>
//  This code was generated by the following tool on 2024-08-26 10:32:31 GMT+01:00:
...
public static unsafe partial class PInvoke
{
    ...
    public static extern ulong TracyAllocSrcloc(uint line, CString source, int sourceSz, CString function, int functionSz);

    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "___tracy_alloc_srcloc_name", CallingConvention = CallingConvention.Cdecl)]
    public static extern ulong TracyAllocSrclocName(uint line, CString source, int sourceSz, CString function, int functionSz, CString name, int nameSz);
    ...
    public static extern void TracyEmitMemoryAlloc(void* ptr, int size, int secure);

    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "___tracy_emit_memory_alloc_callstack", CallingConvention = CallingConvention.Cdecl)]
    public static extern void TracyEmitMemoryAllocCallstack(void* ptr, int size, int depth, int secure);

    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "___tracy_emit_memory_alloc_callstack_named", CallingConvention = CallingConvention.Cdecl)]
    public static extern void TracyEmitMemoryAllocCallstackNamed(void* ptr, int size, int depth, int secure, CString name);

    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "___tracy_emit_memory_alloc_named", CallingConvention = CallingConvention.Cdecl)]
    public static extern void TracyEmitMemoryAllocNamed(void* ptr, int size, int secure, CString name);
    ...
    public static extern void TracyEmitMessage(CString txt, int size, int callstack);

    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "___tracy_emit_message_appinfo", CallingConvention = CallingConvention.Cdecl)]
    public static extern void TracyEmitMessageAppinfo(CString txt, int size);

    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "___tracy_emit_messageC", CallingConvention = CallingConvention.Cdecl)]
    public static extern void TracyEmitMessageC(CString txt, int size, uint color, int callstack);
    ...
    public static extern void TracyEmitZoneName(TracyCZoneCtx ctx, CString txt, int size);

    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "___tracy_emit_zone_text", CallingConvention = CallingConvention.Cdecl)]
    public static extern void TracyEmitZoneText(TracyCZoneCtx ctx, CString txt, int size);
